...
from app.training.reward.zone_entropy_controller import ZoneEntropyController, DEFAULT_ZONE_ENTROPY_FILENAME
...
class StatsPersistCallback(TrainerCallback):
    ...
    def on_step_end(self, args, state, control, **kwargs):
        ...
        self.entropy_controller.on_step_end(round_config=self.round_config)
